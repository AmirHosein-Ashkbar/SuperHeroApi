...
namespace SuperHeroApi.Migrations
{
    ...
    [Migration("20240515192523_LeagueAdded")]
    partial class LeagueAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeagueSuperHero", b =>
                {
                    ...
                    b.HasKey("LeaguesId", "SuperHeroesId");

                    b.HasIndex("SuperHeroesId");

                    b.ToTable("LeagueSuperHero");
                });

            modelBuilder.Entity("SuperHeroApi.Models.League", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeagueSuperHero", b =>
                {
                    b.HasOne("SuperHeroApi.Models.League", null)
                        .WithMany()
